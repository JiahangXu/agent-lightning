...
Respond in the following format, with "REWRITTEN QUERY" replaced by your new query:
...
if __name__ == "__main__":
    ...
    # import datasets
    # dataset = datasets.load_dataset("parquet", data_files="/home/jiahangxu/working/agent-lightning-msft/examples/spider/data/test_dev_500.parquet")["train"]
