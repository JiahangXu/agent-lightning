...
export EXPERIMENT_NAME="spider_check_turn3_truncate4096_0907"
...
# PYTHONPATH=$PYTHONPATH:../.. VERL_API_BASE=http://localhost:9995/ python sql_agent2.py \
